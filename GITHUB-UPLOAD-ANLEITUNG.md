# GeDefense Beta v2 auf GitHub veröffentlichen
...
8. Das Staging mit `python3 scripts/stage-github-upload.py --with-release-assets`
   erneut erzeugen.
9. Den Tag `v2.0.0-beta.1` erstellen und die vier Dateien aus
...
git init -b main
git add --all
git commit -m "GeDefense Beta v2 source release candidate"
```
