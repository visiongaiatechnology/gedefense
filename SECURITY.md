...
GeDefense 4.0.1 is a security-sensitive universal Linux beta. It starts in Observe and requires explicit, gated operator action before Canary or Enforce.
