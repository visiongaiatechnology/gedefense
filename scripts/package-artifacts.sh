...
VERSION=$(tr -d '\r\n' < "$ROOT/VERSION")
SOURCE_NAME="VGT_GeDefense_Beta_v4_4.0.1_Source.zip"
RUN_NAME="VGT_GeDefense_Beta_v4_4.0.1_OneClick.run"
...
[[ $VERSION == "4.0.1" ]] || { echo "unexpected VERSION: $VERSION" >&2; exit 1; }
...
SOURCE_STAGE="$WORK/VGT_GeDefense_Beta_v4_4.0.1"
